...
public class UserController {
    ...
    public ResponseEntity<UserResponseDTO> getUserByOpenid(@PathVariable String openid) {
        return ResponseEntity.ok(UserResponseDTO.from(userService.findByOpenid(openid)));
    }
    ...
    public ResponseEntity<UserResponseDTO> updateUser(@PathVariable String id, @RequestBody User user) {
        ...
        return ResponseEntity.ok(UserResponseDTO.from(userService.update(id, user)));
    }
}